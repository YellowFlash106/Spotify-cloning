...
async function getSongs(folder) {
    ...
    for (const song of songs) {
        songUL.innerHTML += `<li>
                <img class="invert" src="img/music.svg" alt="playlist">
                <div class="info">
                  <div>${song.replaceAll("%20", " ")}</div>
                  <div>Daud Abrahum</div>
                </div>
                <div class="playnow">
                  <span>Play Now</span>
...
async function main() {
    ...
    // Attach event listener to the play ,next and previous button
    ...
    // Listen to the timeupdate event to update the song time
